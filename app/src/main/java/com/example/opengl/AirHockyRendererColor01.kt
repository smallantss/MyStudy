 ...
 * 添加颜色
 */
class AirHockyRendererColor01(val context: Context) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        //读取着色器资源
        val vertexShaderSource = readTextFileFromResource(context, R.raw.simple_vertex_shader_color)
        val fragmentShaderSource = readTextFileFromResource(context, R.raw.simple_fragment_shader_color)
        //创建顶点着色器和片段着色器
